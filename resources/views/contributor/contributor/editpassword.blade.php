                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-6 h4 font-weight-bold">User - Edit #{{ $user->id }}</div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('contributor.update') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
